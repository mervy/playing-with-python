# https://www.rotadaprogramacao.com/tutorial/calculadora-de-imc-em-python-projeto-python/
...
# Labels superiores, frame de cima
...
l_peso.grid(row=0, column=0, colunspan=1, sticky=NW, pady=10, padx=3)
